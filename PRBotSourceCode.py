...
Total Lines 705
Lines of Code 360 
Lines of Comments 242
Lines of Print Statements 103
    To activate, replace '## print' with 'print'
    To deactivate, replace '  print' with '  ## print'
    (Note: Lines 12 and 13 will be altered as well if you 'replace all')
"""
...
class Page(tk.Frame):
    ...
    def back(self):
        ...
        # If back pressed from final page, decrement from_fin class variable, but don't decrement brand because we are still on the same brand, unlike when next is pressed.
            ...
            # Delete instance of search page to prevent there being multiple search pages 
            del Page.pages[SearchPage.tpc+1]
...
class TagPage(Page):
    ...
    def next_brand(self):
        ...
        if TagPage.brand == len(startPage.pages[1].bran_list_0) - 1:
            pass
        else:
            # Go to next brand
            TagPage.brand += 1
    ...
    def finish(self):
        ...
        ## print('\nbran_list_1 altered = ', HomePage.bran_list_1)
        ## print('bran_list_0 = ', HomePage.bran_list_0)
        ## print('\nbrand = ', TagPage.brand)
        ## print('current brand name = ', HomePage.bran_list_0[TagPage.brand])
        ## print('page count = ', Page.page_count)
...
class SearchPage(Page):
    ...
    blue_fill = PatternFill(start_color='000000FF',
                           end_color='000000FF',
                           fill_type='solid')
        # Denotes unlisted brand that was added
    ...
    def __init__(self, master):
        if not TagPage.saved_tags[HomePage.bran_list_0[TagPage.brand]]:
            ...
            tk.Frame.__init__(self, master)
            # Instantiate total page count variable tpc
            SearchPage.tpc = list(Page.pages.keys())[-1]
            ## print('\nafter pressing finish:')
            ## print('search page key = ', SearchPage.tpc+1)
            # Update class variable for search page
            Page.page_count += 1
            Page.pages[SearchPage.tpc+1] = self
            Page.pages[SearchPage.tpc+1].grid(row=1, column=1, sticky='NSEW')
    ...
    def search(self):
            ...
            ### Test case:
                ...
                for brand in HomePage.bran_list_1:
                    ...
                    if (sum_cons[brand]) and (HomePage.ws1[brand_col+str(cell)].value == brand): 
                        # Note:
                        """
                        Can imporve algorithm. Search unnecesarily being done twice for rows with same articles
                        """
                ...
                # To circumvent error that occurs if user forgets to click one of the radio buttons 
                try:
        ...
        HomePage.BrandWB.save('/Users/SplitShiftKing/Documents/Career/Projects/ProjectRunway/PR_Bot/WithClasses/ProRunOutputFile_sc.xlsx')
